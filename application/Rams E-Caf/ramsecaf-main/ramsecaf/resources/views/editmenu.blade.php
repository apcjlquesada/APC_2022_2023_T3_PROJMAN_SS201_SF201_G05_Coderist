        ...
        <div class="container">
            ...
            <div class="filters-content">
                <div class="row grid">
                    ...
                    <div class="col-sm-6 col-lg-3 all ricemeals">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Chicken Curry.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all ricemeals">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Lechon Paksiw.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all ricemeals">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/2pc BBQ.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all ricemeals">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Salisbury Steak.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all ricemeals">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Pork Tapa.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all pasta">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Cheesy Spaghetti.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all beverages">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Brewed Calamansi Drink.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
                    ...
                    <div class="col-sm-6 col-lg-3 all beverages">
                        <div class="box">
                            <div>
                                <a href="#addtocart" data-bs-toggle="modal" data-bs-target="#addtocart" tabindex="-1">
                                    <div class="img-box">
                                        <img src="images/Calamansi Drink.png" alt="">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <h5>
